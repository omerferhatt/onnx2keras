...
@register_converter("AveragePool")
...
@register_converter("GlobalAveragePool")
def convert_global_avg_pool(node, params, layers, lambda_func, node_name, keras_name):
    ...
    global_pool = keras.layers.GlobalAveragePooling2D(name=keras_name, keepdims=True)
